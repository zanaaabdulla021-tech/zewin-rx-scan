...
class RxColors {
  ...
  static const bg = Color(0xFF14231A);
  static const bg2 = Color(0xFF1B2E21);
  static const paper = Color(0xFFE9E2CB);
  static const paper2 = Color(0xFFDCD2B2);
  static const ink = Color(0xFF221E14);
  static const inkSoft = Color(0xFF5B5640);
  static const amber = Color(0xFFB36A2C);
  static const amberDeep = Color(0xFF8A4E1E);
  static const amberTint = Color(0xFFF0DCC0);
  static const stamp = Color(0xFF93362A);
  static const stampDeep = Color(0xFF722A20);
  static const line = Color(0x29221E14); // ink @ 16%
}
